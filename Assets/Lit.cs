...
public class LightEstimationE
{
    ...
    ComputeShader DebugLight_cs;
    int DebugTexId = Shader.PropertyToID("DebugTex");
    ...
    public LightEstimationE(ComputeShader cs,ComputeShader Debuglit,Material Debugmat, Texture LDRtex, Transform parent)
    {
        ...
        this.DebugLightTex = new RenderTexture(width, height, 0, RenderTextureFormat.ARGBFloat);
        DebugLightTex.enableRandomWrite = true;
